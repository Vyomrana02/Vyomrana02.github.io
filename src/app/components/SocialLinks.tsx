...
export const socialData = [
  { link: 'https://github.com/Vyomrana02/', icon: <Github /> },
  { link: 'https://www.linkedin.com/in/vyomrana/', icon: <Linkedin /> },
  { link: 'https://www.instagram.com/vyom.rana/', icon: <Instagram /> }
]
